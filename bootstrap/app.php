...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withSchedule(function (\Illuminate\Console\Scheduling\Schedule $schedule) {
        ...
        $schedule->command('notification:daily-reminder')->dailyAt('21:00')->timezone('Asia/Ho_Chi_Minh');
        // Gửi báo cáo chi tiêu tuần vào lúc 20:00 ngày Chủ Nhật
        $schedule->command('notification:weekly-summary')->sundays()->at('20:00')->timezone('Asia/Ho_Chi_Minh');
        // Gửi thông báo bắt đầu tháng tài chính mỗi ngày vào lúc 08:00
        $schedule->command('notification:financial-month-start')->dailyAt('08:00')->timezone('Asia/Ho_Chi_Minh');
        ...
        $schedule->command('savings:auto-accumulate')->dailyAt('01:00')->timezone('Asia/Ho_Chi_Minh');
        
        // Cảnh báo số dư ví hụt tiền tối thiểu hàng ngày lúc 08:00
        $schedule->command('notification:check-minimum-balances')->dailyAt('08:00')->timezone('Asia/Ho_Chi_Minh');
        // Phân tích thói quen chi tiêu hàng ngày lúc 22:00
        $schedule->command('notification:daily-habit-analysis')->dailyAt('22:00')->timezone('Asia/Ho_Chi_Minh');
        // Phân tích thói quen hàng tháng vào ngày cuối tháng lúc 23:00
        $schedule->command('notification:monthly-habit-analysis')->lastDayOfMonth('23:00')->timezone('Asia/Ho_Chi_Minh');
        // Phân tích thói quen hàng năm vào ngày 31/12 lúc 23:00
        $schedule->command('notification:yearly-habit-analysis')->yearlyOn(12, 31, '23:00')->timezone('Asia/Ho_Chi_Minh');
    })->create();
