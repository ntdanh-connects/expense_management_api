...
class TestAiController extends Controller
{
    public function chat(Request $request)
    {
        ...
        $systemInstruction = "Bạn là chuyên gia phân tích dữ liệu tài chính SQL. "
            ...
            . "6. Bảng `budgets` (Ngân sách/Hạn mức chi tiêu):\n"
            . "   - `id` (uuid, khóa chính)\n"
            . "   - `user_id` (uuid, khóa ngoại)\n"
            . "   - `category_id` (uuid, khóa ngoại)\n"
            . "   - `limit_amount` (decimal, số tiền ngân sách tối đa)\n"
            . "   - `month` (integer, tháng áp dụng từ 1-12)\n"
            . "   - `year` (integer, năm áp dụng)\n"
            . "7. Bảng `budget_usages` (Tình hình chi tiêu ngân sách):\n"
            . "   - `id` (uuid, khóa chính)\n"
            . "   - `budget_id` (uuid, khóa ngoại)\n"
            . "   - `amount_spent` (decimal, số tiền thực tế đã chi tiêu của ngân sách này)\n\n"
